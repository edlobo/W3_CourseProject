...
| tbodyaccmag-mean                    | (m/s2); "metre per second squared" | Avg Magnitude for body acceleration                                           |
...
| tbodyacc-std-y                      | (m/s2); "metre per second squared" | Standard deviation for body acceleration in Y direction                       |
